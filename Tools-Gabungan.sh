...
echo  "BUKAN HACKER,HANYA SI BODOH YG INGIN BELAJAR IT" | lolcat
...
echo -e "<[¤]>=========================<[¤]>" | lolcat                          
echo -e $b "3. DEFACE${enda}";
echo -e "<[¤]>=========================<[¤]>" | lolcat
echo -e $b "4. SCRIPT-DEFACE-CREATOR${enda}";
echo -e "<[¤]>=========================<[¤]>" | lolcat
echo -e $b "5. WEEMAN${enda}";
echo -e "<[¤]>=========================<[¤]>" | lolcat 
echo -e $b "6. HYDRA${enda}"
echo -e "<[¤]>=========================<[¤]>" | lolcat
echo -e $b "7. IPCS${enda}"
echo -e "<[¤]>=========================<[¤]>" | lolcat
echo -e $b "8. OSIF ${enda}"
echo -e "<[¤]>=========================<[¤]>" | lolcat
echo -e $b "9. MBF${enda}"
echo -e "<[¤]>=========================<[¤]>" | lolcat
echo -e $b "10. CLONE YAHOO${enda}"
echo -e "<[¤]>=========================<[¤]>" | lolcat
echo -e $b "11. Hack FB${enda}"
echo -e "<[¤]>=========================<[¤]>" | lolcat
